...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().teacher(DEFAULT_TEACHER);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().teacher(UPDATED_TEACHER);
        return course;
    }
    ...
    void createCourse() throws Exception {
        ...
        assertThat(testCourse.getTeacher()).isEqualTo(DEFAULT_TEACHER);
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.teacher(UPDATED_TEACHER);
        ...
        Course testCourse = courseList.get(courseList.size() - 1);
        assertThat(testCourse.getTeacher()).isEqualTo(UPDATED_TEACHER);
    }
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.teacher(UPDATED_TEACHER);
