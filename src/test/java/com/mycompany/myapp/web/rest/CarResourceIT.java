...
class CarResourceIT {
    ...
    public static Car createEntity(EntityManager em) {
        Car car = new Car().brand(DEFAULT_BRAND).model(DEFAULT_MODEL);
        return car;
    }
    ...
    public static Car createUpdatedEntity(EntityManager em) {
        Car car = new Car().brand(UPDATED_BRAND).model(UPDATED_MODEL);
        return car;
    }
    ...
    void createCar() throws Exception {
        ...
        restCarMockMvc
            .perform(
                post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(car))
            )
    ...
    void putNewCar() throws Exception {
        ...
        updatedCar.brand(UPDATED_BRAND).model(UPDATED_MODEL);
    ...
    void putNonExistingCar() throws Exception {
        ...
        restCarMockMvc
            .perform(
                put(ENTITY_API_URL_ID, car.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void putWithMissingIdPathParamCar() throws Exception {
        ...
        restCarMockMvc
            .perform(
                put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(car))
            )
    ...
    void partialUpdateCarWithPatch() throws Exception {
        ...
        partialUpdatedCar.brand(UPDATED_BRAND).model(UPDATED_MODEL);
