...
class CountryResourceIT {
    ...
    private static final String DEFAULT_OFFICIAL_LANGUAGE = "AAAAAAAAAA";
    private static final String UPDATED_OFFICIAL_LANGUAGE = "BBBBBBBBBB";
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).officialLanguage(DEFAULT_OFFICIAL_LANGUAGE);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).officialLanguage(UPDATED_OFFICIAL_LANGUAGE);
        return country;
    }
    ...
    void createCountry() throws Exception {
        ...
        assertThat(testCountry.getOfficialLanguage()).isEqualTo(DEFAULT_OFFICIAL_LANGUAGE);
    }
    ...
    void getAllCountries() throws Exception {
        ...
        restCountryMockMvc
            ...
            .andExpect(jsonPath("$.[*].officialLanguage").value(hasItem(DEFAULT_OFFICIAL_LANGUAGE)));
    }
    ...
    void getCountry() throws Exception {
        ...
        restCountryMockMvc
            ...
            .andExpect(jsonPath("$.officialLanguage").value(DEFAULT_OFFICIAL_LANGUAGE));
    }
    ...
    void putNewCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).officialLanguage(UPDATED_OFFICIAL_LANGUAGE);
        ...
        assertThat(testCountry.getOfficialLanguage()).isEqualTo(UPDATED_OFFICIAL_LANGUAGE);
    }
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.name(UPDATED_NAME).officialLanguage(UPDATED_OFFICIAL_LANGUAGE);
