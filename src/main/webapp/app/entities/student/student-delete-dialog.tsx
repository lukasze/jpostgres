...
export const StudentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jpostgresApp.student.delete.question">
        <Translate contentKey="jpostgresApp.student.delete.question" interpolate={{ id: studentEntity.id }}>
