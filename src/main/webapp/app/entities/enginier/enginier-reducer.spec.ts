...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './enginier.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENGINIER_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENGINIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENGINIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENGINIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENGINIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENGINIER actions', async () => {
      const expectedActions = [
        {
