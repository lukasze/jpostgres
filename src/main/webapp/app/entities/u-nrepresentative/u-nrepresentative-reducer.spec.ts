...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './u-nrepresentative.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNREPRESENTATIVE_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNREPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNREPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNREPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNREPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNREPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
